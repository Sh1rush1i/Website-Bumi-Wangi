const containers = document.getElementsByClassName("360view");

// Loop melalui setiap elemen dengan class "360view"
for (let i = 0; i < containers.length; i++) {
    ...
    if (imageSrc) {
        ...
        continue; // Lewati elemen ini jika tidak ada sumber
    }
