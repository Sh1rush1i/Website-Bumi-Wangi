...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Bumi Wangi</span> </a>
                    <div class="nav_list"> 
                        <a href="" id="menu-dashboard" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span></a> 
                        <a href="" id="menu-input-produk" class="nav_link"> <i class='bx bxs-purchase-tag nav_icon'></i></i> <span class="nav_name">Input Produk</span> </a> 
                        <a href="" id="menu-input-wisata" class="nav_link"> <i class='bx bx-leaf nav_icon' ></i></i> <span class="nav_name">Input Wisata</span> </a> 
                        <a href="" id="menu-pembelian"class="nav_link"> <i class='bx bxs-shopping-bag-alt nav_icon' ></i></i> <span class="nav_name">Pesanan</span> </a> 
                </div>           
        ...
        <div class="height-100 bg-light">
            <h4 class="h2"><strong>Dashboard Admin</strong></h4><hr>
                        ...
                        <div class="package-item bg-white shadow position-relative">
                            ...
                            <div class="p-4">
                                ...
                                <div class="product-item">
                                    ...
                                    <a class="h6 text-muted text-truncate-2 d-block mt-2" href="#">Ini deskripsi produk yang panjang</a>
                                </div>
                ...
                <div class="container-fluid">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="satuan" name="satuan" placeholder="Masukkan satuan produk" required>
                        </div>

                        <!-- Upload Photo -->
                        <div class="mb-3">
                            <label for="uploadPhoto" class="form-label">Upload Photo</label>
                            <input type="file" class="form-control" id="uploadPhoto" name="uploadPhoto" accept=".jpeg, .jpg, .png" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="uploadVideo" name="uploadVideo" accept=".mp4">
